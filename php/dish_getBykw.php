<?php
    ...
    // $_sql = "SELECT 
    // list.shopName,list.shopid,list.shop_img,dish.sid,dish.img_sm,dish.name,dish.price 
    // FROM  
    // elem_dish 
    // AS dish LEFT JOIN 
    // store
    // AS list ON 
    // list.shopid = dish.shopid 
    // WHERE
    // dish.name
    // LIKE '%$_kw%' ";
    $_sql = " SELECT * FROM wangshop WHERE shopname LIKE '%$_kw%' OR shopDetails LIKE' %$_kw%' ";
